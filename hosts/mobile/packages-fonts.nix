  ...
  environment.systemPackages = (with pkgs; [
    ...
    ## Programming Language & Tools
      ...
      # Python
        ...
        # pip                       # Утилита pip для установки пакетов.
        # watchfiles                # Перезапускает скрипты при изменении файлов (для разработки).
        # typer                     # Создание CLI-приложений из функций с аннотациями типов. Проще и современнее argparse.
        # structlog                 # Структурированное логирование: логи в JSON, контекст (user_id), интеграция с FastAPI.
        # pendulum                  # Улучшенная работа с датами и временными зонами (альтернатива datetime).
        # faker                     # Генерация фейковых данных: имена, email, адреса и т.д.
        # python-dotenv             # Загрузка переменных окружения из .env-файлов.
        # pydantic                  # Валидация данных, DTO, настройки с типизацией. Основа FastAPI.
        # opentelemetry-sdk         # Сбор телеметрии (трассировка, метрики) для микросервисов.
        # loguru                    # Простой и красивый логгер с цветами, ротацией файлов, трассировкой.
        # cryptography              # Шифрование, хэши, цифровые подписи, TLS.
        # passlib                   # Безопасное хэширование паролей (bcrypt, scrypt, argon2).
        # python-jose               # Работа с JWT (JSON Web Tokens) — для аутентификации.
        # numpy                     # Числовые массивы и математические операции.
        # pandas                    # Анализ и обработка табличных данных.
        # polars                    # Быстрее pandas, ленивые вычисления, движок на Rust. Отличен для больших данных.
        # matplotlib                # Базовая визуализация графиков.
        # seaborn                   # Статистические графики поверх matplotlib.
        # plotly                    # Интерактивные, веб-совместимые графики.
        # sqlalchemy                # Мощный ORM и SQL-билдер.
        # asyncpg                   # Асинхронный драйвер для PostgreSQL.
        # asyncmy                   # Асинхронный драйвер для MySQL.
        # redis                     # Клиент для Redis (поддерживает async через redis.asyncio).
        # aio-pika                  # Асинхронная работа с RabbitMQ.
        # fastapi                   # Современный ASGI-фреймворк с автоматической OpenAPI и валидацией.
        # uvicorn                   # ASGI-сервер для запуска FastAPI.
        # aiogram                   # Асинхронный фреймворк для Telegram-ботов.
        # pytest                    # Unit тестирование ПО
        # httpx                     # Мощная замена requests для работы с API
    ...
    ## 📦 Базовые системные утилиты
        ...
        hunspellDicts.en_US                         # Словарь английского языка
        hunspellDicts.ru_RU                         # Словарь русского языка
