...

{
  ...
  environment.systemPackages = (with pkgs; [
    ## Programming Language
      ...
      # Python
        python313                                 # Интерпретатор Python 3.13.
        python313Packages.pip                     # Утилита pip для установки пакетов.
        python313Packages.watchfiles              # Перезапускает скрипты при изменении файлов (для разработки).
